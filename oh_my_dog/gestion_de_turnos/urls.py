...
urlpatterns = [
    ...
    path('rechazar_turno/<id>/<motivo>/',views.rechazar_turno, name= "rechazar_turno"),
    ...
    path('reprogramar_turno_aprobado/<id>/',views.reprogramar_turno_aprobado, name= "reprogramar_turno_aprobado"),
]